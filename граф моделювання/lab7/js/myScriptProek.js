...
window.onload=function(){
	...
	function drawLines(ctx, arr, delay, pause) {
		...
		function delayDraw() {
			...
			//proek
			ctx.beginPath();
			var x1=(20+250*arr[i][0]+500*arr[i][1])/(150+0.9*arr[i][0]+0.6*arr[i][1])
			var y1=(25+350*arr[i][0]+200*arr[i][1])/(150+0.9*arr[i][0]+0.6*arr[i][1]);
			

			++i;

			var x2=(20+250*arr[i][0]+500*arr[i][1])/(150+0.9*arr[i][0]+0.6*arr[i][1])
			var y2=(25+350*arr[i][0]+200*arr[i][1])/(150+0.9*arr[i][0]+0.6*arr[i][1]);
